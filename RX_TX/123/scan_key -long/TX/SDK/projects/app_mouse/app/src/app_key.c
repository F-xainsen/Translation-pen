...
//     }
    ...
    {
        RF_flag |= flag_key_released ;   //0x00000010
        if(old_key_shake)
        {
            if(key_count_shake >= SHORT_CNT)   //SHORT_CNT = 2
            {
                RF_flag &= ~flag_key_pressed ;  //0x00000020
                RF_flag |= flag_key_short ;     //0x00000040
                RF_flag &= ~flag_key_long ;     //0x00000080
