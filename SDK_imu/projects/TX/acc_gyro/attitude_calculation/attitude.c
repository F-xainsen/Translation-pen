...
//		numbers[0] = attitude->interface.data.a_x;
//		numbers[1] = attitude->interface.data.a_y;
//		numbers[2] = attitude->interface.data.a_z;
//    numbers[3] = attitude->interface.data.g_x;
//    numbers[4] = attitude->interface.data.g_y;
//    numbers[5] = attitude->interface.data.g_z;
...
//		numbers[0] = attitude->data.gyro_correct.x;
//		numbers[1] = attitude->data.gyro_correct.y;
//		numbers[2] = attitude->data.gyro_correct.z;
//    printFloats(numbers, 3, 2);
/////////////////////////////////////////////////////////////////////////////////////////////////
	// 一阶龙格库塔更新四元数值
	attitude->process.quaternion[0] += (-attitude->process.quaternion[1] * attitude->data.gyro_correct.x - attitude->process.quaternion[2] * attitude->data.gyro_correct.y - attitude->process.quaternion[3] * attitude->data.gyro_correct.z) * 0.5;
	attitude->process.quaternion[1] +=  (attitude->process.quaternion[0] * attitude->data.gyro_correct.x + attitude->process.quaternion[2] * attitude->data.gyro_correct.z - attitude->process.quaternion[3] * attitude->data.gyro_correct.y) * 0.5;
	attitude->process.quaternion[2] +=  (attitude->process.quaternion[0] * attitude->data.gyro_correct.y - attitude->process.quaternion[1] * attitude->data.gyro_correct.z + attitude->process.quaternion[3] * attitude->data.gyro_correct.x) * 0.5;
	attitude->process.quaternion[3] +=  (attitude->process.quaternion[0] * attitude->data.gyro_correct.z + attitude->process.quaternion[1] * attitude->data.gyro_correct.y - attitude->process.quaternion[2] * attitude->data.gyro_correct.x) * 0.5;

	numbers[0] = attitude->process.quaternion[0];
	numbers[1] = attitude->process.quaternion[1];
	numbers[2] = attitude->process.quaternion[2];
	numbers[2] = attitude->process.quaternion[3];
...
//	numbers[0] = attitude->data.acc_correct.x;
